...
public interface FileOperatorListener {
    static int ERROR_CODE_SUCCESS = 0x00;
    static int ERROR_CODE_USER_CANCEL = 0x01;

    static int ERROR_CODE_FILE_NOT_EXIST = 0x02;
    static int ERROR_CODE_DELETE_FAIL = 0x03;
